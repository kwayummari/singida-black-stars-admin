            ...
            <div class="card-body">
              ...
              <form method="POST" target="_top" autocomplete="on"   enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="caption" value="<?php echo $rows4['caption'];?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">News</label>
                  <div class="col-sm-10">
                    <textarea type="text"  rows="20" id="editor" class="form-control" name="news"><?php echo $rows4['news'];?></textarea>
                  </div>
                </div>
