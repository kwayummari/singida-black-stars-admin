                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                            <div class="card-header">
                                                <h4>Chapisho La Blogi</h4>
                                                <h6 style="margin-left: 12cm; color: green;"><?php include('../../api/Blog/index.php') ?></h6>
                                            </div>
                                            <br>
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <textarea required="" id="editor" maxlength="1000" name="maelezo" cols="50" rows="10" class="form-control" placeholder="Yasizidi Maneno 150"></textarea>
                                                    <div class="invalid-feedback">
                                                ...
                                                <input type="hidden" name="date_created" readonly value="<?php echo $current_time_stamp; ?>">
