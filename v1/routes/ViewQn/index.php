                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $fo = 1;
                                                    $re = "SELECT * FROM questions order by id desc;";
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> <?php echo $name . "?"; ?> </td>
                                                            <td>
                                                                <a href="../../routes/SeeAns/?id=<?php echo $ret['id']; ?>" class="btn btn-success">Ona Majibu</a>
                                                                <a href="../../api/DeleteQn/?id=<?php echo $ret['id']; ?>" class="btn btn-danger">Futa</a>
                                                            </td>
